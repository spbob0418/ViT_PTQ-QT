...
VERSION=qft_full_for_checkpoint
...
nohup bash -c "CUDA_VISIBLE_DEVICES=4,5,6,7 python -m torch.distributed.launch --nproc_per_node=4 --master_port=${MASTER_PORT} \
	...
	--resume /home/shkim/SSF_org/SSF/output/fullbits_vit_base_patch16_224/cifar100/qft_full_for_checkpoint/fullbits_vit_base_patch16_224-qft_full_for_checkpoint/checkpoint-0.pth.tar \
