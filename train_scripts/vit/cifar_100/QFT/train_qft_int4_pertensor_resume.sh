...
VERSION=pertensorA_pertokenAG_5e_5_resumeWith_0reg_32_4e_4_10ep
...
nohup bash -c "CUDA_VISIBLE_DEVICES=4,5,6,7 python -m torch.distributed.launch --nproc_per_node=4 --master_port=${MASTER_PORT} \
	...
	--save-best-cp --checkpoint-hist 1 \
	--resume-mode output/fullbits_vit_base_patch16_224/cifar100/full_0reg_32_4e_4_for_10checkpoint/fullbits_vit_base_patch16_224-full_0reg_32_4e_4_for_10checkpoint/checkpoint_10.pth.tar \
